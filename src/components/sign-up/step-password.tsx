  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col flex-1 lg:flex-none">
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <Input
              ...
              required
              autoFocus
              className="h-14 pr-12 rounded-2xl border-gray-200 bg-white text-base placeholder:text-gray-300 focus-visible:ring-blue-500"
            />
            <button
              type="button"
              ...
              <div key={rule.label} className="flex items-center gap-3">
                <div
                  className={`w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 transition-colors duration-200 ${
                    passed ? 'bg-emerald-100' : 'bg-gray-100 border-2 border-gray-300'
                  }`}
                >
      ...
      <Button
        ...
        className="w-full h-14 rounded-2xl bg-blue-500 hover:bg-blue-600 text-white font-bold text-base shadow-lg shadow-blue-200 active:scale-95 transition-all duration-200 disabled:opacity-40 flex items-center justify-center gap-2"
      >
