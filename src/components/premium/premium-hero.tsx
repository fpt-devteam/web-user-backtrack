...
export function PremiumHero() {
  return (
    <div className="bg-white rounded-3xl px-7 py-8 lg:py-10">
      <h1 className="text-4xl lg:text-5xl font-extrabold text-[#111] leading-tight tracking-tight mb-3">
        Unlock Backtrack Premium
      </h1>
      <p className="text-[#999] text-base mb-8 lg:mb-10">
      ...
      <div className="flex flex-col gap-5">
        {FEATURES.map((feature) => (
          <div key={feature} className="flex items-center gap-4">
            ...
            <span className="font-bold text-[#222] text-base">{feature}</span>
          </div>
        ))}
      </div>
    </div>
