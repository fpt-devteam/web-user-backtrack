...
export function ContactDetails({ email, phone }: ContactDetailsProps) {
  return (
    <div className="mb-6">
      ...
      <Button
        size="lg"
        className="w-full mt-6 h-14 rounded-full text-base font-semibold shadow-lg hover:shadow-xl transition-all"
      >
